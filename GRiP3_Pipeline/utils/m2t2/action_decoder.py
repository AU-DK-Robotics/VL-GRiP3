...
from .model_utils import MLP, repeat_new_axis
...
def build_6d_grasp(
    contact_pt, contact_dir, approach_dir, offset, gripper_depth=-0.01 #0.1034 Default
):
    grasp_tr = torch.stack([
        contact_dir,
        torch.linalg.cross(approach_dir, contact_dir),
        approach_dir,
